...
The `barehands.md` wizard pastes hooks into your agent settings so the ring reflects your real session (thinking while it works, idle when it's done) and teaches your assistant the board commands in your AGENTS.md. Run it and you're live in minutes.
